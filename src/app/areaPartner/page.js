...
export default function AreaPartner() {
    ...
    useEffect(() => {
        const fetchFaqs = async () => {
            try {
                const res = await fetch("https://drimtuch-server.onrender.com/api/faqs");
                            ...
                            faqs.map((faq, index) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className={`w-full flex justify-between items-center px-5 py-4 text-left font-semibold text-lg transition-colors cursor-pointer ${openIndex === index
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`transform transition-transform duration-300 ${openIndex === index ? "rotate-180 text-black" : "text-white"
                                                }`}
                                        >
                                            ▼
                                        </span>
